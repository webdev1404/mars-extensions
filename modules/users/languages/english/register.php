...
return [
    ...
    'err_email_invalid' => "The email you entered is not valid",
    'err_email_exists' => "The email you entered is already registered. Please use a different email.",
    ...
    'agreement_read' => "I have read and agree to the registration terms and conditions.",
];
