...
class Register extends View
{
    ...
    public function registrationClosed()
    {
        ...
        return $this->getTemplateByLanguage('text', 'registration-closed');
    }
    ...
    public function registrationAgreement()
    {
        ...
        return $this->getTemplateByLanguage('text', 'registration-agreement');
    }
    ...
    {
        $this->document->title->set($this->__('resend_activation_title'));
    }
}
