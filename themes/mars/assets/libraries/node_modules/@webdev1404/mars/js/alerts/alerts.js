...
class MarsAlerts extends MarsUiContainer {
    ...
    /**
     * Finds the alerts element for a given element. Creates the alerts container if it doesn't exist
    ...
    find (element) {
        ...
        let alert = element.parentElement.querySelector(`.${this.classes.alerts}`) ?? null;
        if (!alert) {
            // create the alerts container if it doesn't exist
            alert = document.createElement('div');
            alert.classList.add(this.classes.alerts);

            element.parentElement.append(alert);
        }
    ...
    /**
     * Cleans the alerts container
     * @param {object} container The container to clean
     * @protected
     */
    clean (container) {
        container = mars.get(container);
...
class MarsAlertInfo extends MarsAlert {
...
mars.define('info', () => new MarsAlertInfo);